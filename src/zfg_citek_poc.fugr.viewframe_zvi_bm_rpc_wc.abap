*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_BM_RPC_WC
*   generation date: 01.04.2020 at 00:31:31
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_BM_RPC_WC       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_WC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_RPC_WC_EXTRACT
TOTAL = ZVI_BM_RPC_WC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_WC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_RPC_WC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_RPC_WC_EXTRACT
TOTAL = ZVI_BM_RPC_WC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_RPC_WC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_WC'
...
TOTAL = ZVI_BM_RPC_WC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_RPC_WC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_RPC_WC-UPD_FLAG NE SPACE.
