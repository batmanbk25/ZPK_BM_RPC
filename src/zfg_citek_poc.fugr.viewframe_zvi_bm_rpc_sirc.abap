*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_BM_RPC_SIRC
*   generation date: 09.09.2019 at 15:40:26
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_BM_RPC_SIRC     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_SIRC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_RPC_SIRC_EXTRACT
TOTAL = ZVI_BM_RPC_SIRC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_SIRC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_RPC_SIRC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_RPC_SIRC_EXTRACT
TOTAL = ZVI_BM_RPC_SIRC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_RPC_SIRC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_SIRC'
...
TOTAL = ZVI_BM_RPC_SIRC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_RPC_SIRC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_RPC_SIRC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_RPC_SIRC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_BM_RPC_SIRC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_RPC_SIRC_EXTRACT
TOTAL = ZVI_BM_RPC_SIRC_TOTAL
